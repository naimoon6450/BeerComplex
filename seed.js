...
const { Category, Supplier, Product, User } = require('./server/db/index');
...
const products = [
  ...
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/PF3TOzy.png',
    price: 10.0,
  },
  {
    name: 'Focal Banger',
    description: `American IPA with Citra & Mosaic hops.`,
    imageUrl: 'https://i.imgur.com/u25DTQY.jpg',
    price: 9.0,
  },
  {
    name: 'Gose',
  ...
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/HdizUej.jpg',
    price: 7.0,
  },
  {
    name: 'Eugene',
    ...
    imageUrl: 'https://i.imgur.com/YhuQDCi.jpg',
    price: 8.0,
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/Y33LNHM.jpg',
    price: 9.0,
  },
  {
  ...
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/ZddNEZ7.jpg',
    price: 7.0,
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/E5r5qYa.jpg',
    price: 10.0,
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/GJTSzie.jpg',
    price: 5.0,
  },
];

const seed = () => {
  db.sync({ force: process.env.DB_FORCE === 'true' }).then(() => {
    console.log('Seeding db...');
    return Promise.all(
      categories.map(category => Category.create(category))
    ).then(categoryArr => {
      return Promise.all(suppliers.map(supplier => Supplier.create(supplier)))
        .then(supplyArr => {
          return Promise.all(products.map(prod => Product.create(prod))).then(
            productArr => {
              ...
              return Promise.all(associationArr).then(
                _associationArr => _associationArr
              );
            }
          );
        })
